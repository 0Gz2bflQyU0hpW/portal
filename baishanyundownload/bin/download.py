...
classpaths = [
              '/data0/workspace/baishanyundownload/baishanyundownload/conf/',
              '/data0/workspace/baishanyundownload/baishanyundownload/target/baishanyundownload-2.0.0.jar',
              '/data0/workspace/baishanyundownload/baishanyundownload/target/baishanyundownload-2.0.0-lib/*']

main_class = 'com.weibo.dip.baishanyundownload.BaishanyunDownloadMain'
