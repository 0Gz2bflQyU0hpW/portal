...
public class Scribe {
  ...
  public interface AsyncIface {
    public void Log(
        List<LogEntry> messages, AsyncMethodCallback<AsyncClient.Log_call> resultHandler)
        throws TException;
  }
    ...
    public ResultCode recv_Log() throws TException {
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(
            TApplicationException.BAD_SEQUENCE_ID, "Log failed: out of sequence response");
      }
      ...
      throw new TApplicationException(
          TApplicationException.MISSING_RESULT, "Log failed: unknown result");
    }
  }
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void Log(List<LogEntry> messages, AsyncMethodCallback<Log_call> resultHandler)
        throws TException {
      checkReady();
      Log_call method_call =
          new Log_call(messages, resultHandler, this, ___protocolFactory, ___transport);
  ...
  public static class Log_args
    ...
    static {
      ...
      tmpMap.put(
          ...
          new FieldMetaData(
              ...
              new ListMetaData(TType.LIST, new StructMetaData(TType.STRUCT, LogEntry.class))));
    ...
    public boolean equals(Object that) {
      ...
      if (that instanceof Log_args) return this.equals((Log_args) that);
      return false;
    }
    ...
    public boolean equals(Log_args that) {
      ...
      if (this_present_messages || that_present_messages) {
        if (!(this_present_messages && that_present_messages)) return false;
  ...
  public static class Log_result
    ...
    public boolean equals(Object that) {
      if (that == null) return false;
      if (that instanceof Log_result) return this.equals((Log_result) that);
      return false;
    }
