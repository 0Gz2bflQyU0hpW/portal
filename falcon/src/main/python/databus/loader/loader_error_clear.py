...
if __name__ == "__main__":
    ...
    fun = 'cmd.run'
    arg = [
        'cat /data0/workspace/hadoop_cdh5/conf/server.properties | grep localpath= | awk -F = \'{print $2}\' | awk -F \';\' \'{for (col=1; col<NF; col++) print ($col"/error/")}\' | xargs -i find {} -type f | xargs rm -rf']
    expr_form = 'list'
