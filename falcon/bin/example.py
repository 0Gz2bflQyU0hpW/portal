...
system_properties = {'log.dir': '/var/log/falcon/example', 'key1': 'value1'}

min_heap_size = '256'
max_heap_size = '1024'

classpaths = ['/data0/workspace/falcon/falcon/target/falcon-2.0.0.jar',
              '/data0/workspace/falcon/falcon/target/falcon-2.0.0-lib/*']

main_class = 'com.weibo.dip.data.platform.falcon.FalconExample'
