...
app_name = "PerformanceAggregation"
...
class_name = "com.weibo.dip.data.platform.datacubic.fulllink.PerformanceAggregation"

jar_path = "/data0/workspace/portal-fulllink-v2/datacubic/target/datacubic-2.0.0-SNAPSHOT-jar-with-dependencies.jar"
