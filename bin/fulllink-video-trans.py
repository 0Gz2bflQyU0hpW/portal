...
app_name = "PerformanceVideoTransV1"
...
class_name = "com.weibo.dip.data.platform.datacubic.fulllink.PerformanceVideoTransV1"

jar_path = "/data0/workspace/video-trans/datacubic/target/datacubic-2.0.0-SNAPSHOT-jar-with-dependencies.jar"
