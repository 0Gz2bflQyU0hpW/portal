 ...
 */
public class MessageKpiV9TableA {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV9TableA.class);
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V9_TABLE_A),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V9_TABLE_A_BUSINESS);
