 ...
 */
public class MessageKpiV8TableA {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV8TableA.class);
  ...
  public static String getInputPath(String date) {
    return "/user/hdfs/rawlog/www_weibomessageboxnt71g_kpipushcost/" + date + "/*";
  }
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V8_TABLE_A),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      session.udf().register(MessageKpiCommon.IP_TO_LOCATION, new IpToLocation(),
          DataTypes.createMapType(DataTypes.StringType, DataTypes.StringType));
      String[] fieldNames =
          {"type", "platformCost", "noticeCenterCost", "mpsCost"};
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V8_TABLE_A_BUSINESS);
