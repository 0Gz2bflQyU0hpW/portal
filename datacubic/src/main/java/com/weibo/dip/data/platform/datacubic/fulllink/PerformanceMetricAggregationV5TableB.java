 ...
 */
public class PerformanceMetricAggregationV5TableB {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceMetricAggregationV5TableB.class);
    ...
    private static String getSQL(String day) throws Exception {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(PerformanceMetricAggregationV5TableB.class
                .getClassLoader().getResourceAsStream("performance_metric_aggregation_v5_table_b.sql"),
                CharEncoding.UTF_8));
