 ...
 */
public class MessageKpiV1TableC {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV1TableC.class);
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V1_TABLE_C),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V1_TABLE_C_BUSINESS);
