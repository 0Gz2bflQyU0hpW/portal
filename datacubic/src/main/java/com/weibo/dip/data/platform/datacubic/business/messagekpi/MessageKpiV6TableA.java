...
/**
 * http. Created by liyang28 on 2018/6/14.
 */
public class MessageKpiV6TableA {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV6TableA.class);
  ...
  public static String getInputPath(String date) {
    return "/user/hdfs/rawlog/www_weibomessageboxnt71g_nginxaccesslog/" + date + "/*";
  }
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V6_TABLE_A),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      JavaRDD<Row> rowRdd = MessageKpiCommon
          .getNotJsonDataRddHttp(sc, getInputPath(date), fieldNames, notMatchCount);
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V6_TABLE_A_BUSINESS);
