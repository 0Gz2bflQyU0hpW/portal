 ...
 */
public class PerformanceMetricAggregationV3TableC {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceMetricAggregationV3TableC.class);
    ...
    private static String getSQL(String day) throws Exception {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(PerformanceMetricAggregationV3TableC.class.getClassLoader().getResourceAsStream("performance_metric_aggregation_v3_table_c.sql"), CharEncoding.UTF_8));
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] fieldNames = {"subtype", "time", "__date", "ua", "network_type", "ip", "sch", "request_url", "result_code", "during_time", "net_time", "parseTime", "lw", "dl", "sc", "ssc", "sr", "ws", "rh", "rb", "ne"};
