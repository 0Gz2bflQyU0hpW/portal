 ...
 */
public class PerformanceMetricAggregationV6TableB {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceMetricAggregationV6TableB.class);
    ...
    private static String getSQL(String day) throws Exception {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(PerformanceMetricAggregationV6TableB.class
                .getClassLoader().getResourceAsStream("performance_metric_aggregation_v6_table_b.sql"),
                CharEncoding.UTF_8));
