...
public class PerformanceAggregation {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceAggregation.class);
    ...
    private static String getSQL() throws IOException {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(PerformanceAggregation.class.getClassLoader().getResourceAsStream("performance_aggregation.sql"), CharEncoding.UTF_8));
        ...
        resultDS.javaRDD().foreachPartition(iterator -> {
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    values.put("index", "dip-fulllink-aggr-" + day.substring(0, 6));
                    values.put("type", "v1");
