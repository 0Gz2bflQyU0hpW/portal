...
/**
 * 发文本、发图片、发视频、发语音 . Created by liyang28 on 2018/6/14.
 */
public class MessageKpiV4TableA {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV4TableA.class);
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V4_TABLE_A),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      session.udf().register(MessageKpiCommon.IP_TO_LOCATION, new IpToLocation(),
          DataTypes.createMapType(DataTypes.StringType, DataTypes.StringType));
      String[] fieldNames =
          {"action", "proto_type", "type", "r", "ap", "ua", "cip", "size", "isSampled", "from",
              "name", "requestStatus"};
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V4_TABLE_A_BUSINESS);
