 ...
 */
public class MessageKpiV1TableB {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV1TableB.class);
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V1_TABLE_B),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V1_TABLE_B_BUSINESS);
