 ...
 */
public class PerformanceMetricAggregationV3TableB {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceMetricAggregationV3TableB.class);
    ...
    private static String getSQL(String day) throws Exception {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(PerformanceMetricAggregationV3TableB.class.getClassLoader().getResourceAsStream("performance_metric_aggregation_v3_table_b.sql"), CharEncoding.UTF_8));
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] fieldNames = {"subtype", "time", "__date", "ua", "network_type", "ip", "sch", "request_url", "result_code", "during_time", "net_time", "parseTime", "lw", "dl", "sc", "ssc", "sr", "ws", "rh", "rb", "ne", "firstframe_status", "quit_status", "trace_dns_ip"};
        ...
        resultDS.javaRDD().foreachPartition(iterator -> {
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    values.put("index", "dip-fulllink-aggr-v3-tableb-" + day.substring(0, 6));
                    values.put("type", "v1");
