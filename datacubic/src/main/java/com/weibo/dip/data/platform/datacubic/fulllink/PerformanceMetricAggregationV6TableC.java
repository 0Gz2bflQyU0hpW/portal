 ...
 */
public class PerformanceMetricAggregationV6TableC {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceMetricAggregationV6TableC.class);
    ...
    private static String getInputPath(String day) throws ParseException {
        return "/user/hdfs/rawlog/app_weibomobile03x4ts1kl_clientperformance/"
        ...
        try {
            reader = new BufferedReader(
                new InputStreamReader(
                    PerformanceMetricAggregationV6TableC.class.getClassLoader()
                        .getResourceAsStream("performance_metric_aggregation_v6_table_c.sql"),
                    CharEncoding.UTF_8));
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] fieldNames = {"subtype", "time", "__date", "ua", "network_type", "ip", "sch",
            "request_url", "result_code", "during_time", "net_time", "parseTime", "dl", "sc", "ssc",
            "sr", "ws", "rb", "ne", "start_cronet", "cronet_dl", "ws_rb", "cronet_finish",
            "ahead_net_localtime", "behind_net_localtime"};
        ...
        resultDS.javaRDD().foreachPartition(iterator -> {
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    values.put("index", "dip-fulllink-aggr-v3-tablec-" + day.substring(0, 6));
                    values.put("type", "v1");
