...
/**
 * 视频上传、图片上传、图片下载、语音播放 . Created by liyang28 on 2018/6/14.
 */
public class MessageKpiV3TableA {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV3TableA.class);
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V3_TABLE_A),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      session.udf().register(MessageKpiCommon.IP_TO_LOCATION, new IpToLocation(),
          DataTypes.createMapType(DataTypes.StringType, DataTypes.StringType));
      String[] fieldNames =
          {"action", "name", "type", "proto_type", "requestStatus", "start", "endTime", "ap", "ua",
              "cip", "size", "isSampled", "from"};
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V3_TABLE_A_BUSINESS);
