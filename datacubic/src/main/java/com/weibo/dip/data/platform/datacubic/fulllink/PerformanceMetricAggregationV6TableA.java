 ...
 */
public class PerformanceMetricAggregationV6TableA {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceMetricAggregationV6TableA.class);
    ...
    private static String getSQL(String day) throws Exception {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(PerformanceMetricAggregationV3TableA.class
                .getClassLoader().getResourceAsStream("performance_metric_aggregation_v6_table_a.sql"),
                CharEncoding.UTF_8));
