 ...
 */
public class SLADebugerByUid {

    private static final Logger LOGGER = LoggerFactory.getLogger(SLADebugerByUid.class);
    ...
    private static String getSQL(String day) throws Exception {
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(SLADebugerByUid.class.getClassLoader()
                .getResourceAsStream("sla_debuger_by_uid.sql"), CharEncoding.UTF_8));
        ...
        resultDS.javaRDD().foreachPartition(iterator -> {
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    values.put("index", "dip-fulllink-aggr-v3-sla-" + day.substring(0, 6));
                    values.put("type", "v1");
