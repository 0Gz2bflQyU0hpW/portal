...
/**
 * 视频播放. Created by liyang28 on 2018/6/14.
 */
public class MessageKpiV2TableB {

  private static final Logger LOGGER = LoggerFactory.getLogger(MessageKpiV2TableB.class);
      ...
      reader = new BufferedReader(
          new InputStreamReader(
              Ideo_Download_Base2slow.class.getClassLoader()
                  .getResourceAsStream(MessageKpiCommon.V2_TABLE_B),
              CharEncoding.UTF_8));
      String line;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      session.udf().register(MessageKpiCommon.IP_TO_LOCATION, new IpToLocation(),
          DataTypes.createMapType(DataTypes.StringType, DataTypes.StringType));
      String[] fieldNames =
          {"action", "requestStatus", "firstFrame", "start", "stallTimes", "ap", "ua", "cip",
              "isSampled", "error"};
      ...
      MessageKpiCommon
          .sendKafka(resultDs, date, outputCount, MessageKpiCommon.V2_TABLE_B_BUSINESS);
