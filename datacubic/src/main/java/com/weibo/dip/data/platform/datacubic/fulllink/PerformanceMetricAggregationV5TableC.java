 ...
 */
public class PerformanceMetricAggregationV5TableC {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceMetricAggregationV5TableC.class);
        ...
        try {
            reader = new BufferedReader(
                new InputStreamReader(
                    PerformanceMetricAggregationV5TableC.class.getClassLoader()
                        .getResourceAsStream("performance_metric_aggregation_v5_table_c.sql"),
                    CharEncoding.UTF_8));
