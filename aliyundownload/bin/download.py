...
classpaths = [
              '/data0/workspace/aliyundownload/aliyundownload/conf/',
              '/data0/workspace/aliyundownload/aliyundownload/target/aliyundownload-2.0.0.jar',
              '/data0/workspace/aliyundownload/aliyundownload/target/aliyundownload-2.0.0-lib/*']

main_class = 'com.weibo.dip.aliyundownload.AliyunDownloadMain'
