...
import com.weibo.dip.scheduler.util.ConsoleTable;
import java.io.File;
...
public class ConsoleSchedulerClient {
  ...
  private static SchedulerClient getClient() throws Exception {
    ...
    Preconditions.checkState(
        ArrayUtils.isNotEmpty(hosts), "server.hosts must be specified in scheduler.properties");
