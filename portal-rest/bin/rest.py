...
system_properties = {'log.dir': '/var/log/portal/rest'}

min_heap_size = '256'
max_heap_size = '1024'

classpaths = ['/data0/workspace/rest/portal-rest/target/portal-rest-2.0.0.jar',
              '/data0/workspace/rest/portal-rest/target/portal-rest-2.0.0-dependencies/*']

main_class = 'com.weibo.dip.rest.Application'
