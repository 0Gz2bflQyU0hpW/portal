...
@Description(
    ...
    extended = "Example: to_wtime($SCHEDULETIME, -1), return: 20180730130000"
)
public class ToWTime extends GenericUDF {
  ...
  public String getDisplayString(String[] children) {
    return getStandardDisplayString("to_wtime", children);
  }
}
